...
exports['create list with nested element'] = function (test) {
    const lst = list.createList(1, list.createList(2));
...
exports['create list with two nils'] = function (test) {
    const lst = list.createList(null, null);
...
exports['is list'] = function (test) {
    const emptylst = list.createList();
    const lst = list.createList(1, 2);
